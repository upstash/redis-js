...
export type RedisConfig = {
  client: HttpClient
  serializer?: false | (<T>(value: T) => string)
  deserializer?: false | (<TResult, TData>(result: TResult) => TData)
  /**
   * If an encryptionKey is provided most data will be encrypted and decrypted client side.
   *
   * Please be aware that not all data types can be encrypted, such as the score in sorted sets.
   */
  ...
  encryption?: {
    ...
    /**
     * By default all keys in redis will be encrypted as well, which makes
     * pattern matching impossible. You can toggle this behavior if you require
     * unencrypted keys.
     *
     * @default true
     */
...
export class Redis {
   ...
   */
  append = (...args: CommandArgs<typeof AppendCommand>) => new AppendCommand(args).exec(this.client)
   ...
   */
  bitpos = (...args: CommandArgs<typeof BitPosCommand>) => new BitPosCommand(args).exec(this.client)
   ...
   */
  decrby = (...args: CommandArgs<typeof DecrByCommand>) => new DecrByCommand(args).exec(this.client)
   ...
   */
  exists = (...args: CommandArgs<typeof ExistsCommand>) => new ExistsCommand(args).exec(this.client)

  /**
   * @see https://redis.io/commands/expire
   */
  expire = (...args: CommandArgs<typeof ExpireCommand>) => new ExpireCommand(args).exec(this.client)
   ...
   */
  getbit = (...args: CommandArgs<typeof GetBitCommand>) => new GetBitCommand(args).exec(this.client)
   ...
   */
  incrby = (...args: CommandArgs<typeof IncrByCommand>) => new IncrByCommand(args).exec(this.client)
   ...
   */
  lindex = (...args: CommandArgs<typeof LIndexCommand>) => new LIndexCommand(args).exec(this.client)
  ...
  lset = <TData>(key: string, index: number, value: TData) =>
    new LSetCommand([key, index, value]).exec(this.client)
   ...
   */
  rename = (...args: CommandArgs<typeof RenameCommand>) => new RenameCommand(args).exec(this.client)
   ...
   */
  setbit = (...args: CommandArgs<typeof SetBitCommand>) => new SetBitCommand(args).exec(this.client)
   ...
   */
  sinter = (...args: CommandArgs<typeof SInterCommand>) => new SInterCommand(args).exec(this.client)
   ...
   */
  strlen = (...args: CommandArgs<typeof StrLenCommand>) => new StrLenCommand(args).exec(this.client)

  /**
   * @see https://redis.io/commands/sunion
   */
  sunion = (...args: CommandArgs<typeof SUnionCommand>) => new SUnionCommand(args).exec(this.client)
   ...
   */
  unlink = (...args: CommandArgs<typeof UnlinkCommand>) => new UnlinkCommand(args).exec(this.client)
   ...
   */
  zcount = (...args: CommandArgs<typeof ZCountCommand>) => new ZCountCommand(args).exec(this.client)

  /**
   * @see https://redis.io/commands/zincrby
   */
  zincrby = <TData>(key: string, increment: number, member: TData) =>
    new ZIncrByCommand<TData>([key, increment, member]).exec(this.client)
  ...
  ) => new ZRangeCommand<TData>(args as any).exec(this.client)
