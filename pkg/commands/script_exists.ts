...
type TupleOfLength<T, L extends number, R extends T[] = []> = R["length"] extends L ? R : TupleOfLength<
	T,
	L,
	[...R, T]
>;
 ...
 */
export class ScriptExistsCommand<T extends [string, ...string[]]> extends Command<
