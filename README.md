...
supported. Platforms like Vercel (only for Next.js), Netlify, Deno, Fastly etc.
provide a polyfill for you. But if you are running on bare node, you need to
either specify a polyfill yourself or change the import path to:
