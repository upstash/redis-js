!function () {
  ...
  var r = function (t) {
    ...
    n = r("object" == typeof globalThis && globalThis) ||
      r("object" == typeof window && window) ||
      r("object" == typeof self && self) || r("object" == typeof t && t) ||
    ...
    y = function (t, e) {
      ...
      var r, n;
      if (
        e && "function" == typeof (r = t.toString) && !g(n = r.call(t))
      ) {
        return n;
      }
  ...
  var Z,
    ...
    et = e(function (t) {
      var e = tt.get, r = tt.enforce, o = String(String).split("String");
    ...
    Dt = function (t) {
      return b(Ct, t) || (Ct[t] = _t && b(Ft, t) ? Ft[t] : Bt("Symbol." + t)),
        Ct[t];
    },
  ...
  pe in [] && Array(1).find(function () {
    ...
    kt({ target: "Array", proto: !0, forced: de || !ve }, {
      find: function (t) {
  ...
  ye in [] && Array(1).findIndex(function () {
    ...
    kt({ target: "Array", proto: !0, forced: me || !be }, {
  ...
  var Se,
    ...
    Ae = function (t) {
      return function (e, r) {
        ...
        return a < 0 || a >= u
          ? t ? "" : void 0
          : (n = i.charCodeAt(a)) < 55296 || n > 56319 || a + 1 === u ||
              (o = i.charCodeAt(a + 1)) < 56320 || o > 57343
          ? t ? i.charAt(a) : n
          : t
          ? i.slice(a, a + 2)
  ...
  var Le = { IteratorPrototype: Se, BUGGY_SAFARI_ITERATORS: ke },
    ...
    Be = function (t, e, r) {
      var n = e + " Iterator";
      return t.prototype = Ht(Ce, { next: c(1, r) }),
        _e(t, n, !1),
        Ne[n] = Fe,
        t;
    },
    ...
    Xe = function (t, e, r, n, o, i, a) {
      ...
      if (
        ...
        if (
          s = { values: f($e), keys: i ? v : f(Ge), entries: f(Ve) }, a
        ) {
  ...
  var br = dt.includes, wr = le("indexOf", { ACCESSORS: !0, 1: 0 });
  kt({ target: "Array", proto: !0, forced: !wr }, {
    includes: function (t) {
  ...
  kt({ target: "Array", stat: !0, forced: Or }, {
    of: function () {
      for (
        var t = 0,
          e = arguments.length,
  ...
  var Lr = !o(function () {
    ...
    Mr = e(function (t) {
      ...
      (t.exports = function (t, r, n, o, i) {
        ...
        if (i) a = t;
          ...
          if (nr(u)) {
            for (s = 0, c = ct(t.length); c > s; s++) {
              if (
                (f = o ? p(R(h = t[s])[0], h[1]) : p(t[s])) && f instanceof e
              ) {
                return f;
              }
            }
        ...
        for (l = a.next; !(h = l.call(a)).done;) {
          if (
            "object" == typeof (f = tr(a, p, h.value, o)) && f && f instanceof e
          ) {
            return f;
          }
        }
    ...
    Nr = function (t, e, r) {
      var n, o;
      return qe && "function" == typeof (n = e.constructor) && n !== r &&
        g(o = n.prototype) && o !== r.prototype && qe(t, o),
        t;
    },
    Cr = function (t, e, r) {
      ...
      if (
        It(
          t,
          "function" != typeof s || !(a || c.forEach && !o(function () {
                (new s()).entries().next();
              })),
        )
      ) {
  ...
  var Un = vn.trim,
    Mn = n.parseFloat,
    _n = 1 / Mn(fn + "-0") != -Infinity
      ? function (t) {
        var e = Un(String(t)), r = Mn(e);
        return 0 === r && "-" == e.charAt(0) ? -0 : r;
      }
      : Mn;
  kt({ target: "Number", stat: !0, forced: Number.parseFloat != _n }, {
    parseFloat: _n,
  });
  var Nn = vn.trim,
    Cn = n.parseInt,
    Fn = /^[+-]?0[Xx]/,
    Bn = 8 !== Cn(fn + "08") || 22 !== Cn(fn + "0x16")
      ? function (t, e) {
        var r = Nn(String(t));
        return Cn(r, e >>> 0 || (Fn.test(r) ? 16 : 10));
      }
      : Cn;
  kt({ target: "Number", stat: !0, forced: Number.parseInt != Bn }, {
    parseInt: Bn,
  });
  var Dn = s.f,
    qn = function (t) {
    ...
    Wn = zn.entries;
  kt({ target: "Object", stat: !0 }, {
    entries: function (t) {
      return Wn(t);
    },
  }),
    kt({ target: "Object", stat: !0, sham: !i }, {
  ...
  kt({ target: "Object", stat: !0, forced: Kn }, {
    keys: function (t) {
      return qt(Lt(t));
    },
  });
  ...
  kt({ target: "Reflect", stat: !0, forced: Xn }, {
    ...
    kt({ target: "Reflect", stat: !0 }, {
      get: function t(e, r) {
        ...
        return R(e) === i
          ? e[r]
          : (n = O.f(e, r))
          ? b(n, "value") ? n.value : void 0 === n.get ? void 0 : n.get.call(i)
          : g(o = Ie(e))
          ? t(o, r, i)
          : void 0;
      },
    }),
    kt({ target: "Reflect", stat: !0, sham: !i }, {
      getOwnPropertyDescriptor: function (t, e) {
        return O.f(R(t), e);
      },
    }),
    kt({ target: "Reflect", stat: !0, sham: !Re }, {
  ...
  kt({ target: "Reflect", stat: !0 }, {
    ...
    kt({ target: "Reflect", stat: !0, sham: !Lr }, {
  ...
  var Uo = Cr("Set", function (t) {
    ...
    No = function t(e, r) {
      ...
      var i, a, u = t(o, r);
      return u.length
        ? n.length ? (i = new Uo(n.concat(u)), Mr(i, (a = []).push, a), a) : u
        : n;
    };
  kt({ target: "Reflect", stat: !0 }, {
  ...
  (bi || Si || wi) && (mi = function (t) {
    ...
    return a &&
      ...
      Si && n && n.length > 1 && yi.call(n[0], r, function () {
  ...
  var Oi,
    ...
    ji = (Oi = !1,
      ...
      !0 === Ri.test("abc") && Oi),
    Pi = /./.test;
  kt({ target: "RegExp", proto: !0, forced: !ji }, {
    test: function (t) {
  ...
  _i("replace", 2, function (t, e, r, n) {
            ...
            default:
              ...
              if (f > s) {
                ...
                return 0 === l
                  ? e
                  : l <= s
                  ? void 0 === o[l - 1] ? a.charAt(1) : o[l - 1] + a.charAt(1)
                  : e;
              }
              c = o[f - 1];
          }
    ...
    _i("search", 1, function (t, e, r) {
      return [function (e) {
        ...
        var u = Fi(o, i);
        return Gn(o.lastIndex, a) || (o.lastIndex = a),
          null === u ? -1 : u.index;
      }];
    });
  var Ki = [].push,
  ...
  _i("split", 2, function (t, e, r) {
    var n;
    return n =
      "c" == "abbc".split(/(b)*/)[1] || 4 != "test".split(/(?:)/, -1).length ||
        2 != "ab".split(/(?:ab)*/).length ||
        4 != ".".split(/(.?)(.?)/).length || ".".split(/()()/).length > 1 ||
        "".split(/.?/).length
        ? function (t, r) {
          var n = String(d(this)), o = void 0 === r ? $i : r >>> 0;
          if (0 === o) return [];
          ...
          for (
            var i,
              ...
              f = new RegExp(
                t.source,
                (t.ignoreCase ? "i" : "") + (t.multiline ? "m" : "") +
                  (t.unicode ? "u" : "") + (t.sticky ? "y" : "") + "g",
              );
            (i = Ei.call(f, n)) &&
            !((a = f.lastIndex) > c &&
  ...
  kt({ target: "Set", proto: !0, real: !0, forced: D }, {
    ...
    kt({ target: "Set", proto: !0, real: !0, forced: D }, {
      join: function (t) {
        var e = R(this), r = Xi(e), n = void 0 === t ? "," : String(t), o = [];
  ...
  ea
    ...
    : Qi && (!(Yi = Qi.match(/Edge\/(\d+)/)) || Yi[1] >= 74) &&
      (Yi = Qi.match(/Chrome\/(\d+)/)) && (Ji = Yi[1]);
  var ra = Ji && +Ji,
    na = Dt("species"),
  ...
  var fa = bt.f,
    la = {}.toString,
    ha = "object" == typeof window && window && Object.getOwnPropertyNames
    ...
    Fa = function (t, e) {
      ...
      return Sa(r, { type: ba, tag: t, description: e }),
        i || (r.description = e),
        r;
    },
    Ba = Nt
    ...
    Wa = function (t, e) {
      ...
      if (r !== xa || !b(Ta, n) || b(ka, n)) {
        var o = Ra(r, n);
        return !o || !b(Ta, n) || b(r, ma) && r[ma][n] || (o.enumerable = !0),
          o;
      }
    },
    Ka = function (t) {
  ...
  if (
    _t || (et(
      ...
      kt({ target: "Object", stat: !0, forced: !_t, sham: !i }, {
        create: function (t, e) {
      ...
      kt({ target: "Object", stat: !0, forced: !_t }, {
    ...
    var $a = !_t || o(function () {
      var t = Aa();
      return "[null]" != Oa([t]) || "{}" != Oa({ a: t }) ||
        "{}" != Oa(Object(t));
    });
    kt({ target: "JSON", stat: !0, forced: $a }, {
      stringify: function (t, e, r) {
        for (var n, o = [t], i = 1; arguments.length > i;) {
          o.push(arguments[i++]);
        }
        if (n = e, (g(e) || void 0 !== t) && !Ba(t)) {
          return re(e) || (e = function (t, e) {
            if (
  ...
  kt({ target: "String", stat: !0, forced: !!hu && 1 != hu.length }, {
    ...
    kt({ target: "String", proto: !0, forced: !iu("includes") }, {
      includes: function (t) {
  ...
  var pu = "".repeat || function (t) {
    ...
    mu = gu.start;
  kt({ target: "String", proto: !0, forced: yu }, {
    padStart: function (t) {
  ...
  var Ou = function (t) {
    ...
    Pu = ju
      ...
      : "".trimStart;
  kt({ target: "String", proto: !0, forced: ju }, {
    trimStart: Pu,
    trimLeft: Pu,
  }), ee("String", "trimLeft");
  var Iu = vn.end,
    ...
    ku = Tu
      ...
      : "".trimEnd;
  kt({ target: "String", proto: !0, forced: Tu }, {
    trimEnd: ku,
    trimRight: ku,
  }), ee("String", "trimRight");
  var Lu = Dt("iterator"),
    Uu = !o(function () {
      ...
      return t.pathname = "c%20d",
        ...
        !e.sort || "http://a/c%20d?a=1&c=3" !== t.href || "3" !== e.get("c") ||
        "a=1" !== String(new URLSearchParams("?a=1")) || !e[Lu] ||
        "a" !== new URL("https://a@b").username ||
        "b" !== new URLSearchParams(new URLSearchParams("a=b")).get("a") ||
        "xn--e1aybc" !== new URL("http://тест").host ||
        "#%D0%B1" !== new URL("http://a#б").hash || "a1c3" !== r ||
  ...
  Fr(ds, {
    ...
    Uu || "function" != typeof $u || "function" != typeof Vu ||
    kt({ global: !0, enumerable: !0, forced: !0 }, {
      fetch: function (t) {
        var e, r, n, o = [t];
        return arguments.length > 1 &&
          (g(e = arguments[1]) && cr(r = e.body) === Xu &&
  ...
  var vs,
    ...
    Qs = function (t, e) {
      var r;
      return 2 == t.length && Ps.test(t.charAt(0)) &&
        (":" == (r = t.charAt(1)) || !e && "|" == r);
    },
    Zs = function (t) {
      var e;
      return t.length > 1 && Qs(t.slice(0, 2)) &&
        ...
        switch (i = o[f], c) {
          ...
          case nc:
            if (i && (Is.test(i) || "+" == i || "-" == i || "." == i)) {
              ...
              if (t.scheme = l, r) {
                return void (Xs(t) &&
                  Hs[t.scheme] == t.port && (t.port = null));
              }
              l = "",
                "file" == t.scheme
                  ? c = vc
          ...
          case vc:
            if (t.scheme = "file", "/" == i || "\\" == i) c = gc;
              ...
              if (i == vs) {
                ...
                if ("#" != i) {
                  Zs(o.slice(f).join("")) ||
                  (t.host = n.host, t.path = n.path.slice(), tc(t)), c = bc;
                  continue;
                }
                t.host = n.host,
                  t.path = n.path.slice(),
          ...
          case gc:
            ...
            n && "file" == n.scheme && !Zs(o.slice(f).join("")) &&
          ...
          case bc:
            if (
              ...
              if (
                ".." === (s = (s = l).toLowerCase()) || "%2e." === s ||
                  ".%2e" === s || "%2e%2e" === s
                  ? (tc(t), "/" == i || "\\" == i && Xs(t) || t.path.push(""))
                  : ec(l)
                  ? "/" == i || "\\" == i && Xs(t) || t.path.push("")
                  : ("file" == t.scheme && !t.path.length && Qs(l) &&
    ...
    Ac = function (t) {
      ...
      var s = u.searchParams = new bs(), c = ws(s);
  ...
  if (
    i && zt(Oc, {
      href: Fc(Rc, function (t) {
        var e = Es(this), r = String(t), n = xc(e, r);
      ...
      search: Fc(_c, function (t) {
        ...
        "" == (t = String(t))
          ...
          : ("?" == t.charAt(0) && (t = t.slice(1)),
            e.query = "",
            xc(e, t, Sc)), ws(e.searchParams).updateSearchParams(e.query);
      }),
      searchParams: Fc(Nc),
  ...
  _e(Ac, "URL"),
    ...
    kt({ target: "URL", proto: !0, enumerable: !0 }, {
      toJSON: function () {
    ...
    kt({ target: "WeakMap", proto: !0, real: !0, forced: D }, {
      deleteAll: function () {
        return nn.apply(this, arguments);
      },
    }),
    ...
    kt({ target: "WeakSet", proto: !0, real: !0, forced: D }, {
      addAll: function () {
        return Hi.apply(this, arguments);
      },
    }),
  ...
  Vc && Hc || (Vc = function (t) {
    ...
    "process" == l(Xc)
      ...
      : !n.addEventListener || "function" != typeof postMessage ||
          n.importScripts || o(nf) || "file:" === $c.protocol
      ? qc = "onreadystatechange" in E("script")
        ? function (t) {
  ...
  var Ef,
    ...
    rl = function (t, e, r, n) {
      e.done ||
        (e.done = !0, n && (e = n), e.value = r, e.state = 2, Yf(t, e, !0));
    },
  ...
  Vf && (Cf = function (t) {
    ...
    (Of = Kc.prototype.then,
      et(Kc.prototype, "then", function (t, e) {
        var r = this;
  ...
  kt({ target: "Promise", proto: !0, real: !0, forced: ol }, {
    ...
    "function" != typeof Kc || Kc.prototype.finally ||
      ...
      this._initBody = function (t) {
        ...
        this._bodyInit = t,
          t
            ...
            : this._bodyText = "",
          this.headers.get("content-type") || ("string" == typeof t
