...
export class Pipeline {
   ...
   */
  bitcount = (...args: CommandArgs<typeof BitCountCommand>) => this.chain(new BitCountCommand(args))
   ...
   */
  expireat = (...args: CommandArgs<typeof ExpireAtCommand>) => this.chain(new ExpireAtCommand(args))

  /**
   * @see https://redis.io/commands/flushall
   */
  flushall = (...args: CommandArgs<typeof FlushAllCommand>) => this.chain(new FlushAllCommand(args))
   ...
   */
  get = <TData>(...args: CommandArgs<typeof GetCommand>) => this.chain(new GetCommand<TData>(args))
   ...
   */
  getrange = (...args: CommandArgs<typeof GetRangeCommand>) => this.chain(new GetRangeCommand(args))
  ...
  lset = <TData>(key: string, index: number, value: TData) =>
    this.chain(new LSetCommand([key, index, value]))
   ...
   */
  renamenx = (...args: CommandArgs<typeof RenameNXCommand>) => this.chain(new RenameNXCommand(args))
   ...
   */
  setrange = (...args: CommandArgs<typeof SetRangeCommand>) => this.chain(new SetRangeCommand(args))
   ...
   */
  smembers = (...args: CommandArgs<typeof SMembersCommand>) => this.chain(new SMembersCommand(args))
  ...
  zincrby = <TData>(key: string, increment: number, member: TData) =>
    this.chain(new ZIncrByCommand<TData>([key, increment, member]))
  ...
  ) => this.chain(new ZRangeCommand<TData>(args as any))
